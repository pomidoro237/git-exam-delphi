object DataModule2: TDataModule2
  ...
  object ADOConnection1: TADOConnection
    Connected = True
    ConnectionString = 
      'Provider=Microsoft.Jet.OLEDB.4.0;Data Source=\\apetfs\'#1055#1050#1057'-5\'#1043#1091#1089#1077 +
      #1074'_'#1052#1057'\Otdel_kadrov_2_2\'#1069#1082#1079#1072#1084#1077#1085'\Win32\Debug\otdel_kadrov.mdb;Persi' +
  ...
  object ADOTable2: TADOTable
    ...
    object ADOTable2роль: TWideStringField
      FieldName = #1088#1086#1083#1100
      Size = 255
    end
  end
  ...
  object ADOTable4: TADOTable
    ...
    object ADOTable4Подразделение: TStringField
      FieldKind = fkLookup
      FieldName = #1055#1086#1076#1088#1072#1079#1076#1077#1083#1077#1085#1080#1077
      LookupDataSet = ADOTable1
      LookupKeyFields = #1050#1086#1076'_'#1087#1086#1076#1088#1072#1079#1076#1077#1083#1077#1085#1080#1103
      LookupResultField = #1053#1072#1079#1074#1072#1085#1080#1077'_'#1087#1086#1076#1088#1072#1079#1076#1077#1083#1077#1085#1080#1103
      KeyFields = #1050#1086#1076'_'#1087#1086#1076#1088#1072#1079#1076#1077#1083#1077#1085#1080#1103
      Lookup = True
    end
